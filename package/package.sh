...
rm -f flashcart/_nds/akmenunext/globalsettingspico-init.ini
cd flashcart
...
cp pico/_nds/akmenunext/globalsettingspico-init.ini pico/_nds/akmenunext/globalsettings-init.ini
rm -f pico/_nds/akmenunext/globalsettingspico-init.ini
cd pico
...
rm -f dsi/_nds/akmenunext/globalsettingspico-init.ini
cd dsi
...
rm -f 3ds/_nds/akmenunext/globalsettingspico-init.ini
cd 3ds
